...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"node_modules/pretty-print-json/dist/pretty-print-json.min.js":[function(require,module,exports) {
//! pretty-print-json v0.2.1 ~ github.com/center-key/pretty-print-json ~ MIT License
function _typeof(a){"@babel/helpers - typeof";return _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(a){return typeof a}:function(a){return a&&"function"==typeof Symbol&&a.constructor===Symbol&&a!==Symbol.prototype?"symbol":typeof a},_typeof(a)}var prettyPrintJson={version:"0.2.1",toHtml:function toHtml(a,b){var c=Object.assign({indent:3,quoteKeys:!1},b),d=function(a){var b=/^"/.test(a)&&"string",c=["true","false"].includes(a)&&"boolean";return"<span class=json-"+(c||"null"===a&&"null"||b||"number")+">"+a+"</span>"},e=/^( *)("[^"]+": )?("[^"]*"|[\w.+-]*)?([{}[\],]*)?$/mg,f=JSON.stringify(a,null,c.indent);return function htmlEntities(a){return a.replace(/&/g,"&amp;").replace(/\\"/g,"&bsol;&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}(f).replace(e,function replacer(a,b,e,f,g){var h={indent:b,key:e,value:f,end:g},i=c.quoteKeys?/(.*)(): /:/"([\w]+)": |(.*): /,j=h.indent||"",k=h.key&&h.key.replace(i,"$1$2"),l=h.key?"<span class=json-key>"+k+"</span>: ":"",m=h.value?d(h.value):"",n=h.end||"";return j+l+m+n})}};"object"===("undefined"==typeof module?"undefined":_typeof(module))&&(module.exports=prettyPrintJson),"object"===("undefined"==typeof window?"undefined":_typeof(window))&&(window.prettyPrintJson=prettyPrintJson);
...
var BASE_URL = 'https://water-monitoring.information.qld.gov.au/cgi/webservice.pl?';
...
var dataResponceElm = document.getElementById('dataResponce');
var apiGetLatestWaterDataElm = document.getElementById('apiGetLatestWaterData');
var groupedLatestVariablesByVaribleElm = document.getElementById('groupedLatestVariablesByVarible');

var getAvailableData = function getAvailableData(responseData) {
  var variables = getVariables(responseData);
...
var getVariables = function getVariables(data) {
  var allVariblesVariable = [];

  data._return.map(function (item) {
    var sites = item._return.sites[0];
    sites.variables.map(function (item) {
      return allVariblesVariable.push(item.variable);
    });
  });

  return (0, _toConsumableArray2.default)(new Set(allVariblesVariable));
}; // grouped Varibles


var groupVaribles = function groupVaribles(data) {
  var allVaribles = [];
  allVaribles.concat(['AT', 'A', 'ATQ'].forEach(function (dc, index) {
    data._return[index]._return.sites[0].variables.map(function (item) {
...
var groupLatestVariablesByVarible = function groupLatestVariablesByVarible(variables, groupedVaribles) {
  var latastPeriodEndDate = '';
  var datasource = '';
  var finalData = [];
  var site_id = null;
  variables.forEach(function (value) {
    latastPeriodEndDate = '';
    groupedVaribles.filter(function (item) {
      site_id = item.site_id;

      if (item.variable === value && (latastPeriodEndDate < item.periodEnd || latastPeriodEndDate === '')) {
        latastPeriodEndDate = item.periodEnd;
        datasource = item.datasource;
      }
    });
    finalData.push({
      latastPeriodEndDate: latastPeriodEndDate,
...
var apiGetWaterDataQueryUrl = function apiGetWaterDataQueryUrl(siteID) {
  return BASE_URL + JSON.stringify(firstQuery(siteID));
};

var apiGetWaterData = /*#__PURE__*/function () {
  var _ref = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(siteID) {
    var response;
...
var apiGetLatestWaterData = /*#__PURE__*/function () {
  var _ref2 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2(latestQuery) {
    var response;
...
var siteID = '922101B';
actionButtonElm.addEventListener('click', function () {
  return apiGetWaterData(siteIdInputElm.value);
}, false); // actionButtonElm.onclick(console.log('',siteIdInputElm.value))
},{"@babel/runtime/regenerator":"node_modules/@babel/runtime/regenerator/index.js","@babel/runtime/helpers/asyncToGenerator":"node_modules/@babel/runtime/helpers/asyncToGenerator.js","@babel/runtime/helpers/toConsumableArray":"node_modules/@babel/runtime/helpers/toConsumableArray.js","../styles/app.scss":"styles/app.scss","axios":"node_modules/axios/index.js","pretty-print-json":"node_modules/pretty-print-json/dist/pretty-print-json.min.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
